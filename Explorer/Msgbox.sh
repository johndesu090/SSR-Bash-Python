...
'\E[96;45m╚═\E[0m' '\E[96;45m══\E[0m' \
'\E[96;45m═╝\E[0m' '##')
#Frame order: top left top top right left bottom left bottom bottom right
...
if [ "$1" = "" ] ; then
  ...
  message=('Here is a message box.' 'Here is a small tip selection box' 'Made by JohnFordTV (ZHIYB)')\
  choose=('Exit' 'Quit' 'Escape' 'exit the program')
