...
echo -e "\nWithin a minute, the iptables configuration will be reset automatically."
echo "Please try to establish a new SSH connection test！"
echo "If there are no problems, enter johnfordtv to complete the configuration, and other values will also reset."
read -n 6 -t 60 rsum
if [[ ${rsum} == johnfordtv ]];then
